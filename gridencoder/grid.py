...
class GridEncoder(nn.Module):
    def __init__(self, input_dim=3, num_levels=16, level_dim=2, per_level_scale=2, base_resolution=16, log2_hashmap_size=21, desired_resolution=None, gridtype='hash', align_corners=False):
        super().__init__()
